      ...
      body: Center(
        child: Card(
          ...
          shape: RoundedRectangleBorder(
            ...
            // side:const BorderSide(width: 10,color: Colors.black),
          ),
          child: Container(
            height: 300,
            width:200,
                 ...
                 const Expanded(
                   child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("My Card", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                        SizedBox(height: 8),
                        Text("Additional Information"),
                        SizedBox(height: 16),
                        Text("This is the content of the card. You can add more text or widgets here."),
                      ],
                    ),
                               ),
                 ),
